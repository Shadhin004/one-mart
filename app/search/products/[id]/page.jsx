                                            ...
                                            <div className="show-product-area-details">
                                                ...
                                                <div className="product-thumb-area">
                                                    ...
                                                    <div className="thumb-wrapper one filterd-items figure">
                                                        <div className="product-thumb zoom" onMouseMove={(event)=> zoom(event)} style={{ backgroundImage: "url(/assets/images/shop/01.jpg)" }}><img src="/assets/images/shop/01.jpg" alt="product-thumb"/>
                                                        </div>
                                                    </div>
                                                    <div className="thumb-wrapper two filterd-items hide">
                                                        <div className="product-thumb zoom" onMouseMove={(event)=> zoom(event)} style={{ backgroundImage: "url(/assets/images/shop/02.jpg)" }}><img src="/assets/images/shop/02.jpg" alt="product-thumb"/>
                                                        </div>
                                                    </div>
                                                    <div className="thumb-wrapper three filterd-items hide">
                                                        <div className="product-thumb zoom" onMouseMove={(event)=> zoom(event)} style={{ backgroundImage: "url(/assets/images/shop/03.jpg)" }}><img src="/assets/images/shop/03.jpg" alt="product-thumb"/>
                                                        </div>
                                                    </div>
                                                    <div className="thumb-wrapper four filterd-items hide">
                                                        <div className="product-thumb zoom" onMouseMove={(event)=> zoom(event)} style={{ backgroundImage: "url(/assets/images/shop/04.jpg)" }}><img src="/assets/images/shop/04.jpg" alt="product-thumb"/>
                                                        </div>
                                                    </div>
                                                    <div className="thumb-wrapper five filterd-items hide">
                                                        <div className="product-thumb zoom" onMouseMove={(event)=> zoom(event)} style={{ backgroundImage: "url(/assets/images/shop/05.jpg)" }}><img src="/assets/images/shop/05.jpg" alt="product-thumb"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
